...
const Sidebar = ({ data }) => {
  ...
  return (
    <div className="bg-zinc-800 p-8 rounded flex flex-col items-center justify-between h-auto lg:h-[100%]">
      ...
      <button
        className="bg-zinc-900 w-full md:w-3/4 lg:w-full mt-4 text-white font-semibold flex items-center justify-center py-2 rounded hover:bg-white hover:text-zinc-900 transition-all duration-300"
        onClick={() => {
